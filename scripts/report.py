...
local_log=ROOT/'adapters/local-full/metrics.jsonl'
if not local_log.exists():local_log=OUT/'local-training-metrics.jsonl'
local_records=[json.loads(l) for l in local_log.read_text().splitlines()]
